...
| **smart-search** | Route search, lookup, and research requests to the right OpenCLI source | "Search the web/social/dev sources for this topic" |
...
- [`skills/smart-search/SKILL.md`](./skills/smart-search/SKILL.md) — route search and research tasks
...
| `OPENCLI_ALLOW_SESSION0_AUTOSTART` | unset | Windows and WSL: explicitly allow daemon/browser auto-start in non-interactive Session 0. By default OpenCLI requires process creation to happen in a signed-in desktop session. |
